...
namespace Com.Kana.Service.Upload.Test.Facades.ExternalPurchaseOrderTests.Reports
{
	...
	public class TotalPurchaseByUnitsTest
    {
		//private IServiceProvider ServiceProvider { get; set; }
		//public TotalPurchaseByUnitsTest(ServiceProviderFixture fixture)
		//{
		...
		//}
		//[Fact]
		//public async Task Should_Success_Get_Report_Total_Purchase_By_Units_Data_Null_Parameter()
		//{
		...
		//	var Response = Facade.GetTotalPurchaseByUnitsReport(null, null, 7);
		//	Assert.NotEqual(1, 0);
		//}
		//[Fact]
		//public async Task Should_Success_Get_Detail_Report_Total_Purchase_By_Units_Data()
		//{
		//	ExternalPurchaseOrder externalPurchaseOrder = await DataUtil.GetNewData("unit-test");
		//	await FacadeEPO.Create(externalPurchaseOrder, "unit-test", 7);
		...
		//}
		//[Fact]
		//public async Task Should_Success_Get_Report_Total_Purchase_By_Units_Data_Excel_Null_Parameter()
		//{
		//	ExternalPurchaseOrder externalPurchaseOrder = await DataUtil.GetNewData("unit-test");
		//	await FacadeEPO.Create(externalPurchaseOrder, "unit-test", 7);
		//	var Response = Facade.GenerateExcelTotalPurchaseByUnits(null, null, 7);
		...
		//	var Response = Facade.GenerateExcelTotalPurchaseByUnits(DateFrom, DateTo, 7);
		//	Assert.IsType<System.IO.MemoryStream>(Response);
		//}
	}
}
