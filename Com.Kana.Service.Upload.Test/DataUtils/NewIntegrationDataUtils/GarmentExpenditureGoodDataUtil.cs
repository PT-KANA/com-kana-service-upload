...
using Buyer = Com.Kana.Service.Upload.Lib.ViewModels.NewIntegrationViewModel.GarmentExpenditureGood.Buyer;
using GarmentComodity = Com.Kana.Service.Upload.Lib.ViewModels.NewIntegrationViewModel.GarmentExpenditureGood.GarmentComodity;
