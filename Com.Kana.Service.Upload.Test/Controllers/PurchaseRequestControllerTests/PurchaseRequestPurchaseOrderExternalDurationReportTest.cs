...
namespace Com.Kana.Service.Upload.Test.Controllers.PurchaseRequestControllerTests
{
  //  [Collection("TestServerFixture Collection")]
    public class PurchaseRequestPurchaseOrderExternalDurationReportTest
    {
  //      private const string MediaType = "application/json";
  //      private readonly string URI = "v1/duration-report/purchase-request-to-purchase-order-external-duration-reports";
