...
namespace Com.Kana.Service.Upload.Test.Controllers.ExternalPurchaseOrderTests.Reports
{
	//[Collection("TestServerFixture Collection")]
	public class TotalPurchaseByUnitsControllerTest
    {
		//private const string MediaType = "application/json";
		//private readonly string URI = "v1/purchase-orders/reports/units";
		...
		//}
		//public TotalPurchaseByUnitsControllerTest(TestServerFixture fixture)
		//{
		//	TestFixture = fixture;
		//}
		//[Fact]
		...
		//}
		//[Fact]
		//public async Task Should_Success_Get_DetailReport()
		//{
