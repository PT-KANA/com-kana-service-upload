...
namespace Com.Kana.Service.Upload.Test.Controllers.ExternalPurchaseOrderTests.Reports
{
	...
	public class TotalPurchaseBYCategoriesControllerTest
    {
		//private const string MediaType = "application/json";
		//private readonly string URI = "v1/purchase-orders/reports/categories";
		...
		//}
		//public TotalPurchaseBYCategoriesControllerTest(TestServerFixture fixture)
		//{
		//	TestFixture = fixture;
		//}
		//[Fact]
