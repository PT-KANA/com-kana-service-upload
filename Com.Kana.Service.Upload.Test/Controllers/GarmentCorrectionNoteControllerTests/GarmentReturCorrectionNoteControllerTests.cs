...
using Com.Kana.Service.Upload.WebApi.Controllers.v1.GarmentCorrectionNoteControllers;
...
namespace Com.Kana.Service.Upload.Test.Controllers.GarmentCorrectionNoteControllerTests
{
    public class GarmentReturCorrectionNoteControllerTests
    {
        ...
        private void Test_Get_PDF_By_Id(string correctionType)
        {
            ...
            GarmentReturnCorrectionNoteController controller = GetController(mockFacade, null, mockMapper, mockGarmentDeliveryOrderFacade, mockGarmentInternalPurchaseOrderFacade);
