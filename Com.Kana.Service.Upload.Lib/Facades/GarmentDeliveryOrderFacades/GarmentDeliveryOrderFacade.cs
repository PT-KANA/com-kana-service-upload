...
namespace Com.Kana.Service.Upload.Lib.Facades.GarmentDeliveryOrderFacades
{
    public class GarmentDeliveryOrderFacade : IGarmentDeliveryOrderFacade
    {
        ...
        public GarmentDeliveryOrderFacade(IServiceProvider serviceProvider, UploadDbContext dbContext)
        {
