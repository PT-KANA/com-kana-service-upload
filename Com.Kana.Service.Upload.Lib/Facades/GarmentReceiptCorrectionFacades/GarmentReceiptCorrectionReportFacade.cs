...
namespace Com.Kana.Service.Upload.Lib.Facades.GarmentCorrectionNoteFacades
{
    public class GarmentReceiptCorrectionReportFacade:IGarmentReceiptCorrectionReportFacade
    {
        ...
        public GarmentReceiptCorrectionReportFacade(UploadDbContext dbContext, IServiceProvider serviceProvider )
        {
