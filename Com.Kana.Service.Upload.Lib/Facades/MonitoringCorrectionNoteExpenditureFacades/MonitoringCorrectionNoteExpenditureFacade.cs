...
using Com.Kana.Service.Upload.Lib.ViewModels.MonitoringCorrectionNoteExpenditureViewModel;
...
namespace Com.Kana.Service.Upload.Lib.Facades.MonitoringCorrectionNoteExpenditureFacades
{
    public class MonitoringCorrectionNoteExpenditureFacade : IMonitoringCorrectionNoteExpenditureFacade
    {
        ...
        public MemoryStream GenerateExcelMonitoringKeluarNK(DateTime? dateFrom, DateTime? dateTo, int page, int size, string Order, int offset, string jnsBC)
        {
            ...
            else
            {
                ...
                {
                    index++;
                    string AccountDate = item.AccountDate == new DateTime(1970, 1, 1) ? "-" : item.AccountDate.ToOffset(new TimeSpan(offset, 0, 0)).ToString("dd MMM yyyy", new CultureInfo("id-ID"));
        ...
        private List<MonitoringCorrectionNoteExpenditureViewModel> GetMonitoringKeluarNKByUserReportQuery(DateTime? dateFrom, DateTime? dateTo, int offset, int page, int size, string jnsBC)
        {
            ...
            List<MonitoringCorrectionNoteExpenditureViewModel> listDO = new List<MonitoringCorrectionNoteExpenditureViewModel>();
            ...
            var Query = (from
                        ...
                        n in dbContext.GarmentCorrectionNotes
                         ...
                         {
                             CorrectionDate = n.CorrectionDate,
            ...
            foreach (var item in queryResult)
            {
                ...
                MonitoringCorrectionNoteExpenditureViewModel monitoringcorrectionnoteexpenditureViewModel = new MonitoringCorrectionNoteExpenditureViewModel();

                monitoringcorrectionnoteexpenditureViewModel.index = i;
                ...
                monitoringcorrectionnoteexpenditureViewModel.CustomsType = beaCukai == null ? "-" : beaCukai.CustomsType;
                monitoringcorrectionnoteexpenditureViewModel.BeaCukaiNo = beaCukai == null ? "-" : beaCukai.BeacukaiNo;
                monitoringcorrectionnoteexpenditureViewModel.BeaCukaiDate = beaCukai == null ? new DateTime(1970, 1, 1) : beaCukai.BeacukaiDate;
                monitoringcorrectionnoteexpenditureViewModel.PaymentType = deliveryOrder.PaymentMethod;
                monitoringcorrectionnoteexpenditureViewModel.CodeRequirement = deliveryOrderDetail.CodeRequirment;
                monitoringcorrectionnoteexpenditureViewModel.BuyerName = purchaseOrderInternal.BuyerName;
                monitoringcorrectionnoteexpenditureViewModel.ProductType = beaCukai.CustomsType == "BC 262" ? "JASA" : "BARANG";
                monitoringcorrectionnoteexpenditureViewModel.ProductFrom = purchaseOrderExternal.SupplierImport ? "IMPORT" : "LOKAL";
                monitoringcorrectionnoteexpenditureViewModel.SupplierCode = deliveryOrder.SupplierCode;
                monitoringcorrectionnoteexpenditureViewModel.SupplierName = deliveryOrder.SupplierName;
                monitoringcorrectionnoteexpenditureViewModel.Article = purchaseOrderInternal.Article;
                monitoringcorrectionnoteexpenditureViewModel.RONo = purchaseOrderInternal.RONo;
                monitoringcorrectionnoteexpenditureViewModel.DONo = deliveryOrder.DONo;
                monitoringcorrectionnoteexpenditureViewModel.ArrivalDate = deliveryOrder.ArrivalDate;
                monitoringcorrectionnoteexpenditureViewModel.InvoiceNo = invoice == null ? "" : invoice.InvoiceNo;
                monitoringcorrectionnoteexpenditureViewModel.IncomeTaxNo = invoice == null ? "" : invoice.IncomeTaxNo;
                monitoringcorrectionnoteexpenditureViewModel.IncomeTaxDate = invoice == null ? new DateTime(1970, 1, 1) : invoice.IncomeTaxDate;
                monitoringcorrectionnoteexpenditureViewModel.EPONo = deliveryOrderDetail.POSerialNumber;
                monitoringcorrectionnoteexpenditureViewModel.ProductCode = deliveryOrderDetail.ProductCode;
                monitoringcorrectionnoteexpenditureViewModel.ProductName = deliveryOrderDetail.ProductName;
                monitoringcorrectionnoteexpenditureViewModel.ProductRemark = purchaseOrderInternalItem.ProductRemark;
                monitoringcorrectionnoteexpenditureViewModel.DOQuantity = deliveryOrderDetail.DOQuantity;
                monitoringcorrectionnoteexpenditureViewModel.UOMUnit = deliveryOrderDetail.UomUnit;
                monitoringcorrectionnoteexpenditureViewModel.PricePerDealUnit = (double)deliveryOrder.DOCurrencyRate * deliveryOrderDetail.PricePerDealUnit;
                monitoringcorrectionnoteexpenditureViewModel.PriceTotal = (double)deliveryOrder.DOCurrencyRate * deliveryOrderDetail.PriceTotal;
                monitoringcorrectionnoteexpenditureViewModel.Conversion = deliveryOrderDetail.Conversion;
                monitoringcorrectionnoteexpenditureViewModel.SmallQuantity = deliveryOrderDetail.SmallQuantity;
                monitoringcorrectionnoteexpenditureViewModel.SmallUOMUnit = deliveryOrderDetail.SmallUomUnit;
                monitoringcorrectionnoteexpenditureViewModel.InternNo = deliveryOrder.InternNo;
                monitoringcorrectionnoteexpenditureViewModel.INDate = internNote == null ? new DateTime(1970, 1, 1) : internNote.INDate;
                monitoringcorrectionnoteexpenditureViewModel.URNNo = unitReceiptNote == null ? "-" : unitReceiptNote.URNNo;
                monitoringcorrectionnoteexpenditureViewModel.ReceiptDate = unitReceiptNote == null ? new DateTime(1970, 1, 1) : unitReceiptNote.ReceiptDate;
                monitoringcorrectionnoteexpenditureViewModel.UnitName = unitReceiptNote == null ? "-" : unitReceiptNote.UnitName;
                monitoringcorrectionnoteexpenditureViewModel.ReceiptQuantity = unitReceiptNoteItem == null ? 0 : unitReceiptNoteItem.ReceiptQuantity;
                monitoringcorrectionnoteexpenditureViewModel.URNUOMUnit = unitReceiptNoteItem == null ? "-" : unitReceiptNoteItem.UomUnit;
                monitoringcorrectionnoteexpenditureViewModel.URNPricePerDealUnit = unitReceiptNoteItem == null ? 0 : (decimal)deliveryOrder.DOCurrencyRate * unitReceiptNoteItem.PricePerDealUnit;
                monitoringcorrectionnoteexpenditureViewModel.URNPriceTotal = unitReceiptNoteItem == null ? 0 : (decimal)deliveryOrder.DOCurrencyRate * (unitReceiptNoteItem.PricePerDealUnit * unitReceiptNoteItem.ReceiptQuantity);
                monitoringcorrectionnoteexpenditureViewModel.URNConversion = unitReceiptNoteItem == null ? 0 : unitReceiptNoteItem.Conversion;
                monitoringcorrectionnoteexpenditureViewModel.URNSmallQuantity = unitReceiptNoteItem == null ? 0 : unitReceiptNoteItem.SmallQuantity;
                monitoringcorrectionnoteexpenditureViewModel.URNSmallUOMUnit = unitReceiptNoteItem == null ? "-" : unitReceiptNoteItem.SmallUomUnit;
            
                var CNDate = new DateTimeOffset(monitoringcorrectionnoteexpenditureViewModel.CorrectionDate.Date, TimeSpan.Zero);
                var URNDate = new DateTimeOffset(monitoringcorrectionnoteexpenditureViewModel.ReceiptDate.Date, TimeSpan.Zero);
                var datediff = (((TimeSpan)(CNDate - URNDate)).Days);

                monitoringcorrectionnoteexpenditureViewModel.AccountDate = correctionNote.CorrectionType == "Retur" && datediff >= 0 ? correctionNote.CorrectionDate : monitoringcorrectionnoteexpenditureViewModel.ReceiptDate;                

                listDO.Add(monitoringcorrectionnoteexpenditureViewModel);
                i++;
            }
            return listDO;
        }
        ...
        public MemoryStream GenerateExcelMonitoringKeluarNKByUser(DateTime? dateFrom, DateTime? dateTo, int page, int size, string Order, int offset, string JnsBC)
        {
            ...
            result.Columns.Add(new DataColumn() { ColumnName = "No", DataType = typeof(String) });
            result.Columns.Add(new DataColumn() { ColumnName = "Tgl Pembukuan", DataType = typeof(String) });
            result.Columns.Add(new DataColumn() { ColumnName = "No. Nota Koreksi", DataType = typeof(String) });
            result.Columns.Add(new DataColumn() { ColumnName = "Tgl Nota Koreksi", DataType = typeof(String) });
            result.Columns.Add(new DataColumn() { ColumnName = "Tipe Koreksi", DataType = typeof(String) });
            result.Columns.Add(new DataColumn() { ColumnName = "Jumlah Koreksi", DataType = typeof(String) });
