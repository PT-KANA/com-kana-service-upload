...
using Com.Kana.Service.Upload.Lib.ViewModels.MonitoringCorrectionNoteReceptionViewModel;
...
namespace Com.Kana.Service.Upload.Lib.Facades.MonitoringCorrectionNoteReceptionFacades
{
    public class MonitoringCorrectionNoteReceptionFacade : IMonitoringCorrectionNoteReceptionFacade
    {
        ...
        public MonitoringCorrectionNoteReceptionFacade(UploadDbContext dbContext)
        {
