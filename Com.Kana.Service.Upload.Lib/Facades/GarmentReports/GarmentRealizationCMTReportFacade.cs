...
using Com.Kana.Service.Upload.Lib.ViewModels.NewIntegrationViewModel.GarmentInvoice;
...
namespace Com.Kana.Service.Upload.Lib.Facades.GarmentReports
{
    public class GarmentRealizationCMTReportFacade : IGarmentRealizationCMTReportFacade
    {
        ...
        public GarmentRealizationCMTReportFacade(IServiceProvider serviceProvider, UploadDbContext dbContext)
        {
