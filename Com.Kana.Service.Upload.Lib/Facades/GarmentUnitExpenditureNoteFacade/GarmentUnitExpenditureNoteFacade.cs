...
namespace Com.Kana.Service.Upload.Lib.Facades.GarmentUnitExpenditureNoteFacade
{
    public class GarmentUnitExpenditureNoteFacade : IGarmentUnitExpenditureNoteFacade
    {
        ...
        public GarmentUnitExpenditureNoteFacade(IServiceProvider serviceProvider, UploadDbContext dbContext)
        {
