...
namespace Com.Kana.Service.Upload.Lib.Facades.MonitoringCentralBillExpenditureFacades
{
    public class MonitoringCentralBillExpenditureFacade : IMonitoringCentralBillExpenditureFacade
    {
        ...
        public MonitoringCentralBillExpenditureFacade(UploadDbContext dbContext)
        {
