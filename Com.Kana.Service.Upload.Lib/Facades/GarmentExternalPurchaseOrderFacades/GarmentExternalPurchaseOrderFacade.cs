...
namespace Com.Kana.Service.Upload.Lib.Facades.GarmentExternalPurchaseOrderFacades
{
    public class GarmentExternalPurchaseOrderFacade : IGarmentExternalPurchaseOrderFacade
    {
        ...
        public GarmentExternalPurchaseOrderFacade(IServiceProvider serviceProvider, UploadDbContext dbContext)
        {
