...
using Com.Kana.Service.Upload.Lib.ViewModels.ExternalPurchaseOrderViewModel.Reports;
...
namespace Com.Kana.Service.Upload.Lib.Facades.ExternalPurchaseOrderFacade.Reports
{
	public class TotalPurchaseFacade
	{
		...
		public TotalPurchaseFacade(IServiceProvider serviceProvider, UploadDbContext dbContext)
		{
