...
namespace Com.Kana.Service.Upload.Lib.Facades.GarmentPurchaseRequestFacades
{
    public class GarmentPurchaseRequestItemFacade : IGarmentPurchaseRequestItemFacade
    {
        ...
        public GarmentPurchaseRequestItemFacade(IServiceProvider serviceProvider, UploadDbContext dbContext)
        {
