...
namespace Com.Kana.Service.Upload.Lib.ViewModels.MonitoringCorrectionNoteExpenditureViewModel
{
	public class MonitoringCorrectionNoteExpenditureViewModel
    {
