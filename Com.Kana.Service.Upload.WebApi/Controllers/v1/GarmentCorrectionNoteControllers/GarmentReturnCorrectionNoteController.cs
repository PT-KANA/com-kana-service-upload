...
using Com.Kana.Service.Upload.Lib.PDFTemplates.GarmentCorrectionNotePDFTemplates;
using Com.Kana.Service.Upload.Lib.PDFTemplates.GarmentCorrectionNotePDFTemplates.GarmentReturnCorrectionNote;
using Com.Kana.Service.Upload.Lib.Services;
using Com.Kana.Service.Upload.Lib.ViewModels.GarmentCorrectionNoteViewModel;
...
namespace Com.Kana.Service.Upload.WebApi.Controllers.v1.GarmentCorrectionNoteControllers
{
    [Produces("application/json")]
    [ApiVersion("1.0")]
    [Route("v{version:apiVersion}/garment-return-correction-notes")]
    [Authorize]
    public class GarmentReturnCorrectionNoteController : Controller
    {
        private string ApiVersion = "1.0.0";
        public readonly IServiceProvider serviceProvider;
        private readonly IMapper mapper;
        private readonly IGarmentReturnCorrectionNoteFacade facade;
        private readonly IdentityService identityService;

        public GarmentReturnCorrectionNoteController(IServiceProvider serviceProvider, IMapper mapper, IGarmentReturnCorrectionNoteFacade facade)
        {
        ...
        public IActionResult Get(int id)
        {
            try
            {
                ...
                else
                {
                    ...
                    var stream = GarmentReturnCorrectionNotePDFTemplate.Generate(model, serviceProvider, clientTimeZoneOffset);
        ...
        public IActionResult GetReturnNotePpn(int id)
        {
            try
            {
                ...
                else
                {
                    ...
                    var stream = GarmentReturnCorrectionNotePpnPDFTemplate.Generate(model, serviceProvider, clientTimeZoneOffset);
        ...
        public IActionResult GetReturnNotePph(int id)
        {
            try
            {
                ...
                else
                {
                    ...
                    var stream = GarmentReturnCorrectionNotePphPDFTemplate.Generate(model, serviceProvider, clientTimeZoneOffset);
