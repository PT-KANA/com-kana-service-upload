...
namespace Com.Kana.Service.Upload.WebApi.Controllers.v1.PurchaseRequestControllers
{
	[Produces("application/json")]
	[ApiVersion("1.0")]
	[Route("v{version:apiVersion}/duration-report/purchase-request-to-purchase-order-duration-reports")]
	[Authorize]
	public class PurchaseRequestPurchaseOrderDurationReportController : Controller
	{
		private string ApiVersion = "1.0.0";
		private readonly IMapper _mapper;
		private readonly PurchaseRequestFacade _facade;
		private readonly IdentityService identityService;
		public PurchaseRequestPurchaseOrderDurationReportController(IMapper mapper, PurchaseRequestFacade facade, IdentityService identityService)
		{
			_mapper = mapper;
			_facade = facade;
		...
		public IActionResult GetReport(string unitId, string duration,  DateTime? dateFrom, DateTime? dateTo, int page, int size, string Order = "{}")
		{
			...
			try
			{
				...
				var data = _facade.GetPRDurationReport(unitId,duration, dateFrom, dateTo,page,size,Order, offset);
